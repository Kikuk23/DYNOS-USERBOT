...
async def amireallyalive(alive):
    ...
    output = (
        f"**[DYNOS-USERBOT](https://github.com/Kikuk23/DYNOS-USERBOT) Update dan berjalan.**\n\n"
        f"**╭✠╼━━━━━━❖━━━━━━━✠╮**\n"
        f"       **{aliver}**\n"
        f"**╰✠╼━━━━━━❖━━━━━━━✠╯**\n\n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"❃ **Modul**           ➥ `{len(modules)}` \n\n"
        f"**▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰**\n"
        f"[{REPO_NAME}](https://github.com/Kikuk23/DYNOS-USERBOT) || [𝗚𝗥𝗢𝗨𝗣]({GROUP_LINK}) || [𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠]({IG_ALIVE})\n"
        f"**▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ **")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━❖━━━━━━━✠╯ \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ \n"
        f"[{REPO_NAME}](https://github.com/Kikuk22/DYNOS-USERBOT) || [𝐆𝐑𝐎𝐔𝐏]({GROUP_LINK}) || [𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE}) \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
